  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-gradient-to-r from-purple-900 to-indigo-900 shadow-sm z-50">
      <nav className="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        <Link href="/">
            <Image 
            src="https://i.postimg.cc/dVPyKmsN/LOGO-TECKWARE.webp" 
            alt="Teckware Logo" 
            width={100} 
            height={100} />
        </Link>
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <Link href="#explore">
            <p className="bg-purple-900 text-white px-4 py-2 rounded-full hover:bg-purple-600 transition duration-300 font-bold">
              Contacto
            </p>
          </Link>
        </div>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col space-y-4 py-4 px-6">
              ...
              <Link href="#explore">
                <p 
                 className="bg-purple-700 text-white font-bold px-4 py-2 rounded-full hover:bg-purple-600 transition duration-300 text-center"
                 onClick={toggleMenu}>
                  Contacto
                </p>
              </Link>
